# -*- coding: utf-8 -*-
"""Arabian Gpt fine-tuning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QFr_kmpcURiCuOXEnvFswLIwMKLEN7na
"""
...
configuration = AutoConfig.from_pretrained('riotu-lab/ArabianGPT-03B', output_hidden_states=False)
model = AutoModelWithLMHead.from_pretrained('riotu-lab/ArabianGPT-03B', config=configuration)
model.resize_token_embeddings(len(tokenizer))
...
tokenizer = AutoTokenizer.from_pretrained("polinasch/ArabianGPT-03B-finetuned-masry-more-data")
model = AutoModelForCausalLM.from_pretrained("polinasch/ArabianGPT-03B-finetuned-masry-more-data")
